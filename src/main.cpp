...
const string strMessageMagic = "optimum Signed Message:\n";
...
// optimum: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "optimum", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Meet the Tiny Bitcoin Wallet that Lives Under Your Skin - Grace Caffyn (@GCaffyn) | Published on November 11, 2014 at 20:46 GMT";
        CTransaction txNew;
        txNew.nTime = 1415752319;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x89ff8540f8fe8527f01deecb00b8e7428c25d099f0f11330cad857ae1e096ce3"));
        block.print();
